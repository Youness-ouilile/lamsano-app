...
const T = {
  ar: {
    ...
    about: { title: "من نحن", text: "Lamsano Sym مشروع حرفي يجمع بين لمسة الجينز الأصيل وروح اللوحة الفنية. كل قطعة تُصنع يدويًا بشغف، لتحمل بين طياتها قصة فريدة تليق بذائقتكم.",feature1: "صناعة يدوية",
  feature2: "تصميم فريد",
  feature3: "مصنوعة بشغف", },
  ...
  fr: {
    ...
    about: { title: "À propos", text: "Lamsano Sym est un projet artisanal qui unit la touche du jean authentique à l'âme de l'œuvre d'art. Chaque pièce est façonnée à la main avec passion, portant en elle une histoire unique qui vous ressemble.",feature1: "Fait main",
  feature2: "Design unique",
  feature3: "Fait avec passion", },
  ...
  en: {
    ...
    about: { title: "About Us", text: "Lamsano Sym is a handcrafted project uniting the touch of authentic demin with the soul of fine art. Every piece is made by hand with passion, carrying a unique story that suits your taste.",feature1: "Handmade",
  feature2: "Unique Design",
  feature3: "Made With Passion", },
